...
-- Global keymaps that are not plugin-specific

local map = vim.keymap.set

-- Better line movement (fallback if Alt keys don't work in your terminal)
-- Uncomment these if <A-j> and <A-k> don't work for you
...
-- Terminal keymaps are handled in the toggleterm plugin configuration
